// 我也不知道该怎么办，使用第三方加载字体，减少数据传输量
var _jf = _jf || [];
_jf.push(['p', '34807']);
_jf.push(['_setFont', 'sourcehansans-sc-regular', 'css', '.sourcehansans-sc-regular']);
_jf.push(['_setFont', 'sourcehansans-sc-regular', 'alias', 'NotoSansSC']);
_jf.push(['_setFont', 'sourcehansans-sc-regular', 'weight', 400]);
(function (f, q, c, h, e, i, r, d) {
    ...
    k.addScript = n = function (u, A, w, C, E, B) {
        ...
        var x = q.createElement("script"), z = q.getElementsByTagName("script")[0], v, y = false, D = function () {
            x.src = "";
...
})(this, this.document, "className", "jf-loading", "jf-active", "jf-inactive", "//ds.justfont.com/js/stable/v/4.9.4/id/159129026865");