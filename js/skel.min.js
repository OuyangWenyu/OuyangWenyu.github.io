...
var skel = function () {
    var e = "config", t = "breakpoints", n = "iterate", r = "stateId", i = "elements", s = "getElementsByClassName",
        o = "stateElements", u = "getElementsByTagName", a = !1, f = "length", l = "parentNode", c = null,
        h = "gutters", p = "insertBefore", d = "push", v = " 0 0 ", m = "getCachedElement", g = "className",
        y = "!important", b = "object", w = "cacheNewElement", E = "newInline", S = "grid", x = "config_breakpoint",
        T = "orientationChange", N = "locations", C = "parseMeasurement", k = "createElement", L = "match",
        A = "newElement", O = "deviceType", M = "padding-top:0!important", _ = "substring", D = !0, P = "viewport",
        H = "cache", B = "_skel_isReversed", j = "}", F = "head", I = "containers", q = "vars", R = "indexOf",
        U = "replace", z = "padding-top:", W = "matchesMedia", X = "extend", V = "events", $ = "isArray",
        J = "onorientationchange", K = ":first-child>:first-child {", Q = "DOMReady", G = "getComputedStyle",
        Y = "addEventListener", Z = "^head", et = "{display:none!important}", tt = "padding:", nt = "registerLocation",
        rt = "hasOwnProperty", it = "defaults", st = "documentElement", ot = "IEVersion", ut = "attachElements",
        at = "horizontal", ft = "plugins", lt = "attachElement", ct = "DOMContentLoaded", ht = "text/css",
        pt = "_skel_attach", dt = "initial-scale=1", vt = "states", mt = "firstChild", gt = ":first-child>*{",
        yt = "placeholder", bt = "removeEventListener", wt = ">*{", Et = "(min-width: ", St = ".row", xt = "resize",
        Tt = "media", Nt = "applyRowTransforms", Ct = "attached", kt = "vertical", Lt = "normalize", At = "change",
        Ot = ".row.uniform", Mt = "html", _t = "collapse", Dt = "forceDefaultState", Pt = "_skel_placeholder",
        Ht = "nextSibling", Bt = "min-height", jt = "max-height", Ft = "querySelectorAll", It = "prototype",
        qt = "max-width", Rt = "innerHTML", Ut = "min-width", zt = "domready", Wt = "android", Xt = ".\\3$1 ",
        Vt = "priority", $t = "readyState", Jt = "onresize", Kt = "isStatic", Qt = "href", Gt = {
            breakpoints: [],
            breakpointList: [],
            ...
            initUtilityMethods: function () {
                document[Y] ? !function (e, t) {
                    ...
                    var n = [], r, i = !1, s = document, o = s[st], u = o.doScroll, a = ct, f = Y, l = "onreadystatechange",
                        c = $t, h = u ? /^loaded|^c/ : /^loaded|c/, p = h.test(s[c]);
